...
# Распределения отличаются от нормального, но при таком большом размере выборки можно проводить t-тест
...
# Это значит, что обновления в рекомендательной системе не повлияли на средний чек пользователей
